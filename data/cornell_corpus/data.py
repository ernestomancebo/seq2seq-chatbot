...
def get_id2line():
    lines = open('raw_data/movie_lines.txt', encoding='utf-8',
...
def get_conversations():
    conv_lines = open('raw_data/movie_conversations.txt',
...
def process_data():
    ...
    qtokenized = [[w.strip() for w in wordlist.split(' ') if w]
                  for wordlist in qlines]
    atokenized = [[w.strip() for w in wordlist.split(' ') if w]
